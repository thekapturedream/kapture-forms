    ...
    subcategories: [
      {
        ...
        forms: [
          ...
          live("Resident admission", "/products/resident-admission", ["admission","intake"]),
          live("Care plan · person-centred", "/products/care-plan-person-centred", ["care plan","outcomes"]),
          live("Falls risk assessment", "/products/falls-risk-assessment", ["falls","FRAT"]),
      ...
      },
      {
        ...
        forms: [
          live("New patient registration", "/products/new-patient-registration", ["GP","NHS number","registration"]),
      ...
      },
      {
        ...
        forms: [
          live("IAPT self-referral", "/products/iapt-self-referral", ["IAPT","talking therapies"]),
      ...
      },
      {
        ...
        forms: [
          ...
          live("Consent & capacity · MCA / DoLS", "/products/consent-capacity-mca-dols", ["MCA","DoLS","capacity"]),
    ...
    subcategories: [
      {
        ...
        forms: [
          ...
          live("Statutory declaration", "/products/statutory-declaration", ["statutory","declaration"]),
          soon("Witness statement", "Q4 2026", ["witness","statement"]),
          soon("Power of attorney · LPA health", "Q1 2027", ["LPA","health","attorney"]),
          live("Power of attorney · LPA finance", "/products/power-of-attorney-lpa-finance", ["LPA","finance"]),
          live("Simple will", "/products/simple-will", ["will","testament"]),
      ...
      },
      {
        ...
        forms: [
          ...
          live("One-way NDA", "/products/one-way-nda", ["NDA","one-way"]),
    ...
    subcategories: [
      {
        ...
        forms: [
          live("Grant application · organisation", "/products/grant-application-organisation", ["grant","org","funding"]),
          soon("Grant application · individual or artist", "Q1 2027", ["grant","artist"]),
          live("Donor pledge & gift form", "/products/donor-pledge-gift-form", ["donor","pledge","gift"]),
          soon("Hardship / emergency fund application", "Q1 2027", ["hardship","emergency"]),
          live("Bursary / scholarship application", "/products/bursary-scholarship-application", ["bursary","scholarship"]),
          live("Sponsorship application", "/products/sponsorship-application", ["sponsorship"]),
      ...
      },
      {
        ...
        forms: [
          ...
          live("Primary school application", "/products/primary-school-application", ["primary","admission"]),
          ...
          live("University course application", "/products/university-course-application", ["university","UCAS"]),
      ...
      },
      {
        ...
        forms: [
          live("Membership application · club", "/products/membership-application-club", ["membership","club"]),
          live("Gym & fitness membership", "/products/gym-fitness-membership", ["gym","fitness"]),
          soon("Professional body registration", "Q1 2027", ["professional","membership"]),
          soon("Co-working / studio membership", "Q1 2027", ["coworking"]),
          live("Society / association sign-up", "/products/society-association-signup", ["society"]),
        ],
      },
      {
        ...
        forms: [
          live("Job application · standard", "/products/job-application-standard", ["job","application"]),
          live("Apprenticeship application", "/products/apprenticeship-application", ["apprenticeship"]),
          live("Volunteer application", "/products/volunteer-application", ["volunteer"]),
          live("Internship / placement application", "/products/internship-placement-application", ["intern","placement"]),
    ...
    subcategories: [
      {
        ...
        forms: [
          live("GP appointment request", "/products/gp-appointment-request", ["GP","appointment","NHS"]),
      ...
      },
      {
        ...
        forms: [
          live("Dental check-up booking", "/products/dental-check-up-booking", ["dentist","check-up"]),
      ...
      },
      {
        ...
        forms: [
          live("Eye test booking · adult", "/products/eye-test-booking-adult", ["eye test","optician"]),
      ...
      },
      {
        ...
        forms: [
          live("Therapy intake form", "/products/therapy-intake-form", ["therapy","intake"]),
          live("Counselling appointment request", "/products/counselling-appointment-request", ["counsellor"]),
      ...
      },
      {
        ...
        forms: [
          live("Hair salon booking", "/products/hair-salon-booking", ["salon","hair"]),
          live("Massage appointment", "/products/massage-appointment", ["massage"]),
    ...
    subcategories: [
      {
        ...
        forms: [
          live("Venue hire enquiry", "/products/venue-hire-enquiry", ["venue","hire"]),
      ...
      },
      {
        ...
        forms: [
          live("Class / workshop sign-up", "/products/class-workshop-sign-up", ["class","workshop"]),
      ...
      },
      {
        ...
        forms: [
          live("Tradesperson site visit", "/products/tradesperson-site-visit", ["trade","quote"]),
          live("Cleaning service booking", "/products/cleaning-service-booking", ["cleaning"]),
      ...
      },
      {
        ...
        forms: [
          live("Wedding enquiry", "/products/wedding-enquiry", ["wedding"]),
          live("Party / function enquiry", "/products/party-function-enquiry", ["party","function"]),
