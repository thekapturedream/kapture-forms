  ...
  return (
    <div className="space-y-3">
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  <div className="font-semibold text-base text-kapture-black dark:text-white tracking-[-0.005em]">
                    {opt.label}
                  </div>
                  <div className="mt-0.5 text-sm text-kapture-smoke dark:text-white/55">
                    {opt.subtitle}
                  </div>
                </div>
                <div className="text-right shrink-0">
                  {opt.rrpPence && (
                    <div className="font-mono text-xs text-kapture-mist dark:text-white/40 line-through">
                  ...
                  {(opt.mode === "subscription" || opt.mode === "pass") && (
                    <div className="text-xs text-kapture-mist dark:text-white/40 font-mono">/mo · 24 mo</div>
                  )}
                  {opt.mode === "preorder" && (
                    <div className="text-[0.6875rem] text-kapture-mist dark:text-white/40">reserve fee</div>
                  )}
                </div>
              </div>
            </button>
      ...
      <div className="rounded-2xl bg-kapture-paper dark:bg-white/[0.04] px-5 py-3.5 flex items-start gap-3 text-sm">
        <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-white dark:bg-white/[0.06] border border-kapture-fog dark:border-white/15 shrink-0 mt-0.5 text-kapture-black dark:text-white font-bold text-xs">?</span>
        <div className="flex-1 min-w-0">
          <div className="font-semibold text-kapture-black dark:text-white">Need help choosing a plan?</div>
      ...
      <button
        ...
        onClick={buy}
        disabled={loading}
        className="w-full inline-flex items-center justify-center gap-2 bg-kapture-yellow text-kapture-black hover:bg-kapture-amber disabled:opacity-60 px-5 py-3.5 rounded-2xl font-semibold text-sm transition active:scale-[0.99]"
      >
        {loading
          ? "Opening Stripe…"
      ...
      <p className="text-center text-xs text-kapture-mist dark:text-white/45">
